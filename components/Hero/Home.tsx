    ...
    >
      ...
      <div
        className={`
          ...
          bg-white/75 p-6 pb-10 shadow-xl shadow-slate-500/25 backdrop-blur-sm
          sm:z-10 sm:-mb-6 sm:w-11/12 sm:p-8
          md:-mr-28 md:mb-0 md:w-[300px] md:p-6
          lg:w-[500px] lg:p-10
        `}
      >
      ...
      <div
        className={`
          relative z-10 -mt-4 flex h-[200px] w-[95vw] grow overflow-hidden
          rounded-xl shadow-md shadow-slate-500
          sm:z-0 sm:mt-0 sm:h-[300px] sm:w-full
